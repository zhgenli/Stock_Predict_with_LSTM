...
def train(config, logger, train_and_valid_data):
    ...
    for epoch in range(config.epoch):
        logger.info("Epoch \033[31m{}\033[0m/\033[36;1m{}\033[0m".format(epoch, config.epoch))
        ...
        logger.info("The train loss is \033[31m{:.6f}\033[0m. ".format(train_loss_cur) +
              "The valid loss is \033[36;1m{:.6f}\033[0m.".format(valid_loss_cur))
